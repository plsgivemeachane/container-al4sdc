...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-al4sdc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-al4sdc.containers.anotherwebservice.com/
...
```
git clone git@github.com:plsgivemeachane/container-al4sdc.git
cd container-al4sdc
```
...
```
docker attach container-al4sdc
```
